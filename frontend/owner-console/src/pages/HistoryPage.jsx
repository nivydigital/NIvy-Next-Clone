...
export default function HistoryPage() {
  ...
  return (
    <div>
      ...
      <p className="muted">OC-4.1 — Runtime audit events (tools, workflows, agent runs).</p>
      ...
      {!loading && items.length === 0 && !error && (
        <div className="banner">No audit events yet. Run an agent or workflow to populate history.</div>
      )}
      <div className="split">
